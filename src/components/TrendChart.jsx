  ...
  return (
    <>
      <div className="glass-card">
        <div style={{ fontSize: 11, color: 'var(--text-dim)', marginBottom: 10, fontWeight: 400, letterSpacing: '0.14em' }}>CALORIES</div>
        <ResponsiveContainer width="100%" height={130}>
          <BarChart data={data}>
            ...
            <Bar dataKey="Calories" fill="var(--accent)" radius={[0, 0, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>

      <div className="glass-card">
        <div style={{ fontSize: 11, color: 'var(--text-dim)', marginBottom: 10, fontWeight: 400, letterSpacing: '0.14em' }}>PROTEIN (G)</div>
        <ResponsiveContainer width="100%" height={130}>
          <BarChart data={data}>
            <CartesianGrid stroke="var(--border)" vertical={false} />
            <XAxis dataKey="date" tickFormatter={tickFormatter} tick={{ fill: 'var(--text-dim)', fontSize: 10 }} axisLine={false} tickLine={false} interval={compactTicks ? 4 : 0} />
            <YAxis hide />
            <Tooltip content={<CustomTooltip />} cursor={{ fill: 'var(--surface-strong)' }} />
            <Bar dataKey="Protein" fill="var(--protein)" radius={[0, 0, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </>
